...
from qwenvl.train.data import make_supervised_data_module
from qwenvl.train.params import DataArguments, ModelArguments, TrainingArguments
from qwenvl.train.train_utils import get_peft_state_maybe_zero_3, get_peft_state_non_lora_maybe_zero_3, safe_save_model_for_hf_trainer
import pathlib
from liger_kernel.transformers import apply_liger_kernel_to_qwen2_vl, apply_liger_kernel_to_qwen2_5_vl
from qwenvl.train.monkey_patch_forward import replace_qwen2_5_with_mixed_modality_forward, replace_qwen_2_with_mixed_modality_forward
...
def train():
    ...
    if "Qwen2.5" in model_args.model_id or "qwen2.5" in model_args.model_id or "qwen25" in model_args.model_id:
